...
import Pignation from "@/app/(main)/_chatbot/(components)/Pignation";
...
import { getInactiveDocumentsByPage } from "@/services/documents/document.service";
import TableHeader from "../(components)/table-header";
import { useUser } from "@/context/UserContext";
import { table_headers } from "../page";
...
export default function DocumentManagement() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => getInactiveDocumentsByPage(currentPage),
  });
        ...
        <div className="h-full flex flex-col bg-base-200">
          ...
          <div className="flex-shrink-0">
            <div className="p-4 sm:p-6 max-w-7xl mx-auto">
              {/* Search and Upload - Fixed */}
              <div className="flex flex-col lg:justify-between gap-4 justify-start md:flex-row md:items-center bg-base-200 sticky top-16 md:top-0 z-5 py-4">
                <input
                  type="text"
              ...
              {/* filters - Fixed */}
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 bg-base-200 sticky top-36 md:top-20 z-5 pb-4">
                <SelectDropdown
              ...
              <div className="space-y-4 mt-4">
                {filteredDocs.map((document) => (
                  <DocumentCard
                    ...
                    showRestoreButton={hasAdminPrivilege}
                    showUpdateButton={false}
                    disableViewFile={true}
                    showIsVectorProcessed={false}
                  />
                ))}
